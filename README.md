...
Android beta.13 requires integration version `0.1.0-beta.13` or newer. Update the integration and restart Home Assistant before connecting a beta.13 Free or Paid app.
